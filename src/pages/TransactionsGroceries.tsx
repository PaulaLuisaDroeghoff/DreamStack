...
const TransactionsGroceries = () => {
  ...
  const [editTransaction, setEditTransaction] = useState({
    transaction: '',
    category: 'Grocery', // Default value for the category
    amount: '',
    date: '',
  });
  ...
  const handleAddTransaction = () => {
    ...
    setEditTransaction({
      transaction: '',
      category: 'Grocery', // Default value for the new transaction
      amount: '',
      date: '',
    });
  };
  ...
  return (
    <div className="container mx-auto p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Groceries Spending</h1>
      </div>
