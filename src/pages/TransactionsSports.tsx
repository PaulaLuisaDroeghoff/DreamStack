...
const TransactionsSports = () => {
  ...
  const [editTransaction, setEditTransaction] = useState({
    transaction: '',
    category: 'Sports', // Default value for the category
    amount: '',
    date: '',
  });
  ...
  const handleAddTransaction = () => {
    ...
    setEditTransaction({
      transaction: '',
      category: 'Sports', // Default value for the new transaction
      amount: '',
      date: '',
    });
  };
  ...
  return (
    <div className="container mx-auto p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Sports Spending</h1>
      </div>
...
export default TransactionsSports;
